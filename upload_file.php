...
<body>
	<div class="container">
		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
			...
			if (move_uploaded_file ($_FILES['the_file']['tmp_name'], "file_upload/{$_FILES['the_file']['name']}")) {
				print '<p>Your file has been uploaded.</p>'; 	} 
			if (move_uploaded_file ($_FILES['the_file1']['tmp_name'], "file_upload/{$_FILES['the_file1']['name']}")) {
					print '<p>Your file has been uploaded.</p>';	}
